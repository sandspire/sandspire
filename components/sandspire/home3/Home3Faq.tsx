...
const FAQS = [
  {
    ...
    a: "No. Food and hospitality is where we cut our teeth, but the same approach works for gyms, salons, clinics, hotels and shops: any brand where people check the feed before they decide to walk in. If that's you, we can help.",
  },
  {
    q: "What's the difference between content and posting?",
    a: "Content is the reels and photos we shoot. Posting is publishing, captioning, and replying day to day. You can take just the content, or hand us the whole feed. Most brands start with content and grow into full management.",
  },
  {
    q: "What is UGC, exactly?",
    a: "User-generated-style content: real faces talking to camera, filmed to look native to the feed rather than like an ad. We cast, brief, and direct it so it stays on-brand.",
  },
  {
    q: "How fast will I see results?",
    a: "You'll have shot footage within the first couple of weeks and a consistent feed inside the first month. Reach and demand build from there, and we report on what actually moved, not just views.",
  },
  {
