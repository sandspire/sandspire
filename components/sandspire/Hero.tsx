              ...
              <div className="flex w-full flex-col gap-14 lg:gap-[5rem]">
                <div className="flex w-full flex-col items-start gap-5 lg:flex-row lg:gap-5">
                  <div className="flex min-w-0 flex-1 flex-col items-start">
                    ...
                    <h1 className="mt-1 font-[family-name:var(--font-display)] not-italic text-[clamp(2.35rem,9vw,6.25rem)] font-semibold leading-[0.98] tracking-[-0.02em] text-white">
