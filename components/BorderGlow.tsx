...
export type BorderGlowProps = {
  ...
  colors?: string[];
  fillOpacity?: number;
  /** Inline layout for buttons and pills. */
  inline?: boolean;
  /** Drop default card shadow (better for nested cards). */
  subtle?: boolean;
};
...
export default function BorderGlow({
  ...
  return (
    <div
      ...
      className={`border-glow-card ${inline ? "border-glow-inline" : ""} ${subtle ? "border-glow-subtle" : ""} ${className}`}
      style={style}
    >
